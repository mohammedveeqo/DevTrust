...
import { Shield, Check, ExternalLink, Menu, X } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900">Devtrust</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/docs" className="text-gray-600 hover:text-blue-600 font-medium">
        ...
        {isOpen && (
          <div className="md:hidden mt-4 space-y-4">
            ...
            <Link to="/docs" className="block text-gray-600 hover:text-blue-600 flex items-center">
              Docs <ExternalLink className="w-4 h-4 ml-1" />
            </Link>
